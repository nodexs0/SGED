            ...
            {user && IsAlumno && (
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#e6d0d4] bg-[#fbf8f9] p-4 flex-col">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-[#1b0e10] text-base font-bold leading-tight">Datos acádemicos</h2>
                  <p className="text-[#964f5a] text-sm font-normal leading-normal">Visualiza tu Kárdex, Estado General, Solicitud Dictamen, Dictamen</p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#e6d0d4] bg-[#fbf8f9] p-4 flex-col">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-[#1b0e10] text-base font-bold leading-tight">Tramites</h2>
                  <p className="text-[#964f5a] text-sm font-normal leading-normal">Realiza Solicitudes, Citas, Visualiza su Seguimiento</p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#e6d0d4] bg-[#fbf8f9] p-4 flex-col">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-[#1b0e10] text-base font-bold leading-tight">ETS</h2>
                  <p className="text-[#964f5a] text-sm font-normal leading-normal">Inscribir ETS, Visualizar Calificaciones</p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#e6d0d4] bg-[#fbf8f9] p-4 flex-col">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-[#1b0e10] text-base font-bold leading-tight">Inscripción Actual</h2>
                  <p className="text-[#964f5a] text-sm font-normal leading-normal">Visualiza tu Horario, Calificaciones</p>
                </div>
              </div>
            </div>
              )}
